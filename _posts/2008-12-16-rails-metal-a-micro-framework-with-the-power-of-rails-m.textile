...
{% highlight text %}
{% highlight ruby %}  # traditional Controller
...
{% highlight text %}
{% highlight ruby %}  # first, let's benchmark the traditional controller
...
{% highlight text %}
{% highlight ruby %}  rackup -s mongrel app/metal/poller.rb
{% endhighlight %}
...
{% highlight text %}
{% highlight ruby %}  $ curl 127.0.0.1:3000/poller
    Hello Middleware!
{% endhighlight %}
