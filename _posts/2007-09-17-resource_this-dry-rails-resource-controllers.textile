...
{% highlight text %}
{% highlight ruby %}git clone git://github.com/jnewland/resource_this.git
{% endhighlight %}
...
{% highlight ruby %}
{% highlight ruby %}  class PostsController < ActionController::Base
   resource_this
  end
{% endhighlight %}
...
{% highlight ruby %}
{% highlight ruby %}  class CommentsController < ActionController::Base
...
{% highlight ruby %}
{% highlight ruby %}  before_filter :load_post
...
{% highlight text %}
{% highlight ruby %}./script/generate resource_this FooKlass [title:string body:text]
{% endhighlight %}
